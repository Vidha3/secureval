...
import com.example.vdha3.secureval.Sentence;
...
public class Entail{
	...
	public static boolean main_entail(String alg, String kBFile, String querySymbol){
		/*
		if(args.length != 3){
		...
		*/
		...
		try{
			...
			*/
			String[] diffLines = kBFile.split("\n");
			for (int i=0; i<diffLines.length; i++){
				sentencesS += diffLines[i].trim().replaceAll(" +", " ") + "@";
			}
